...
public final class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixel9Pro.put("HARDWARE", "komodo");
        propsToChangePixel9Pro.put("MODEL", "Pixel 9 Pro XL");
        propsToChangePixel9Pro.put("ID", "AD1A.240905.004");
    ...
    public static KeyEntryResponse onGetKeyEntry(KeyEntryResponse response) {
        ...
        if (!SystemProperties.getBoolean(SPOOF_PIXEL_INTEGRITY, true)) return response;
